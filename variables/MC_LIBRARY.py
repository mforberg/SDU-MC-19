...
buildings = {
    ...
    "normalHouse": {"probability": NORMALHOUSE_PROBABILITY, "xLength": 5, "zWidth": 5, "yHeight": 6, "floorAndRoof": True},
    ...
    "smallFarm": {"probability": SMALLFARM_PROBABILITY, "xLength": 6, "zWidth": 9, "yHeight": 2, "floorAndRoof": False},
